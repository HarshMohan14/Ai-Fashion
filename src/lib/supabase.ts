...
export type WardrobeItem = {
  ...
  source?: 'seed' | 'extraction' | 'dr_scout' | string | null;
  rendered_at?: string | null;
  scout_source_url?: string | null;
  scout_source_name?: string | null;
  scout_query?: string | null;
  scout_brief?: string | null;
  scout_license_label?: string | null;
  scout_confidence?: number | null;
  scout_collection_key?: string | null;
  scout_collection_title?: string | null;
  scout_imported_at?: string | null;
};
