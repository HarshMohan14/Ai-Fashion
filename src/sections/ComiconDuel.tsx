...
function LoadingScreen() {
  return (
    <div className="grid flex-1 place-items-center text-center">
      <div>
        <Loader2 className="mx-auto mb-4 h-11 w-11 animate-spin text-[#b026ff]" />
  ...
  return (
    <div className="-mx-5 -my-5 relative flex min-h-[100dvh] flex-1 items-center justify-center overflow-hidden bg-black">
      <div className="relative aspect-[941/1672] w-full max-w-[430px]">
        ...
        {loadError && (
          <div className="absolute left-[9%] right-[9%] top-[8%] rounded-2xl border border-[#b026ff]/70 bg-black/80 px-3 py-2 text-center text-xs font-bold leading-snug text-white shadow-[0_0_20px_rgba(255,20,147,0.35)]">
            {loadError}
          </div>
        )}
      </div>
  ...
  return (
    <div className="relative flex flex-1 min-h-0 flex-col gap-2 pb-[max(0.5rem,env(safe-area-inset-bottom))] pt-[max(0.25rem,env(safe-area-inset-top))]">
      ...
      <header className="relative text-center">
        <div className="pointer-events-none absolute left-10 top-5 text-[#b026ff] drop-shadow-[0_0_14px_rgba(255,20,147,0.9)]">
          <Gem className="h-4 w-4 fill-current" />
        </div>
        <div className="pointer-events-none absolute right-9 top-2 text-[#b026ff] drop-shadow-[0_0_14px_rgba(255,20,147,0.9)]">
        ...
        <h1 className="dfb-condensed text-[clamp(2.4rem,8vw,3.2rem)] uppercase italic leading-[0.76] tracking-[-0.045em]">
          ...
          <span className="text-[#b026ff]">Duel</span>
        </h1>
        <div className="dfb-condensed mt-0 flex items-center justify-center gap-2 text-[0.95rem] uppercase tracking-wide text-white/90">
          <span className="h-0.5 w-12 bg-[#b026ff]" />
          Round <span className="text-[#b026ff]">{currentRound}</span> of {totalRounds}
          <span className="h-0.5 w-12 bg-[#b026ff]" />
        </div>
      </header>
      ...
      <div className="relative grid flex-1 min-h-0 grid-cols-2 items-stretch gap-3 pb-1">
        ...
        />
        <div className="pointer-events-none absolute left-1/2 top-1/2 z-30 flex h-11 w-11 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full border-2 border-[#b026ff] bg-black text-center shadow-[0_0_20px_rgba(255,20,147,0.72)]">
      ...
      <div className="flex flex-col items-center gap-1 pb-1">
        <div className="dfb-condensed text-[1.28rem] uppercase italic tracking-widest text-[#b026ff]">
          Pick Your Fit
        </div>
        <button
          type="button"
      ...
      <AnimatePresence>
        {timedOut && (
          ...
          >
            <motion.div
              className="whitespace-nowrap rounded-full border-2 border-white bg-[#b026ff] px-6 py-3 text-2xl font-black uppercase text-black shadow-[0_0_34px_rgba(255,20,147,0.9),0_10px_0_rgba(0,0,0,0.58)]"
      ...
      <div className="relative aspect-[941/1672] w-full max-w-[430px]">
        <AnimatePresence mode="wait">
          {loading || !result ? (
            <motion.div
              key="loading"
              className="absolute inset-4 flex flex-col items-center justify-center overflow-hidden rounded-[30px] border-[3px] border-[#b026ff]/30 bg-[#b026ff]/10"
            ...
            >
              ...
              <div className="relative z-10 flex w-full flex-col items-center justify-center px-6 text-center">
                <Loader2 className="mb-6 h-12 w-12 animate-spin text-[#b026ff]" />
    ...
    <header className="flex items-center justify-between gap-3">
      <div className="flex items-center gap-3">
        <button
          ...
          className="grid h-11 w-11 place-items-center rounded-full border border-[#b026ff] bg-black text-white shadow-[0_0_18px_rgba(255,20,147,0.4)]"
        >
          <ChevronLeft className="h-5 w-5" />
        </button>
        <div className="dfb-condensed text-5xl uppercase italic leading-none tracking-[-0.04em] text-[#b026ff]">
          DFB
        </div>
      </div>
      <div className="flex items-center gap-2.5">
        <div className="grid h-10 w-10 place-items-center rounded-full border border-[#b026ff] bg-black shadow-[0_0_12px_rgba(255,20,147,0.3)]">
          <Gem className="h-5 w-5 fill-[#ff1493] text-[#b026ff]" />
        </div>
...
function ScenarioBox({ scenario, timeLeft }: { scenario: string; timeLeft: number }) {
  ...
  return (
    <section className="relative mx-3 flex items-center justify-between gap-3 rounded-[16px] border-2 border-[#b026ff] bg-black/90 px-4 py-3 shadow-[0_0_16px_rgba(255,20,147,0.42)]">
      <div className="flex-1 text-left">
        <div className="mb-1 text-[10px] font-black uppercase tracking-[0.2em] text-[#b026ff]">
          Scenario
        </div>
      ...
      <div className="relative flex shrink-0 items-center justify-center min-w-[4rem] min-h-[4rem]">
        <motion.div
          className="absolute inset-0 grid place-items-center text-[#b026ff]"
        ...
        <div className="relative z-10 flex flex-col items-center justify-center pt-1">
          ...
          <div className="dfb-condensed -mt-0.5 text-[0.7rem] uppercase italic leading-none text-[#b026ff]">Left</div>
        </div>
      </div>
    </section>
  );
...
function ChoiceCard({
  ...
  const sideClass = side === 'left'
    ? 'border-[#b026ff] shadow-[0_0_24px_rgba(255,20,147,0.45)]'
    : 'border-[#8a2cff] shadow-[0_0_24px_rgba(138,44,255,0.45)]';
  const roseClass = side === 'left'
    ? 'border-[#b026ff] bg-black/88 shadow-[0_0_22px_rgba(255,20,147,0.55)]'
